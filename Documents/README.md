...
当前状态：阶段 13 已完成，阶段 14 正在开发；已完成房间大厅、等待室广播、准备、等待/已结束房间退出、牌局中返回大厅/退出登录处理、结束后再开一局入口、开始房间、Bot 补位、真实牌局创建、多人玩家视角同步和牌局结束后房间状态同步基础，后续重点补齐重连、原房间再开局、牌局恢复、地方规则和 Docker 长期运行能力。
