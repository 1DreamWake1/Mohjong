...
- 阶段 14 正在开发，已完成房间大厅、等待室广播、准备、等待/已结束房间退出、开始房间、Bot 补位、真实牌局创建、多人玩家视角同步和牌局结束后房间状态同步基础。
...
阶段状态：进行中，已完成房间大厅、等待室广播、准备、等待/已结束房间退出、开始房间、Bot 补位、真实牌局创建、多人玩家视角同步和牌局结束后房间状态同步基础。
